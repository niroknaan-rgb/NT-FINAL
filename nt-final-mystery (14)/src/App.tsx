...
const PRELOAD_IMAGES = [
  ...
  "https://i.postimg.cc/cHkJp9sy/syr-'m-mym.png",
    ...
    <div className="absolute inset-0 z-[100000] flex flex-col items-center justify-center bg-black/85 p-6 text-center backdrop-blur-md" dir="rtl">
      {isMobile ? (
        <div className="bg-[#1c1c1e]/95 border border-emerald-500/40 rounded-3xl p-8 max-w-sm w-full flex flex-col items-center shadow-2xl relative">
          ...
          <p className="text-[3.5cqw] md:text-sm font-medium mb-4 font-sans text-emerald-400">הסאונד והמוזיקה הם חלק בלתי נפרד מפתרון התעלומות והאווירה של המשחק.</p>
          <p className="text-[3.2cqw] md:text-xs font-light mb-6 font-sans text-zinc-400">מומלץ לחבר אוזניות או להגביר ווליום לחוויה חושית מקסימלית! 🎧</p>
          <button 
        ...
        >
          ...
          {isPotOnStove && (
            ...
            >
              {!isPastaInPot ? (
                <img
                  src="https://i.postimg.cc/cHkJp9sy/syr-'m-mym.png"
