...
const Entrance = ({
  ...
  const customClownAnimate = animationPhase === "walking"
    ? {
        bottom: "6%",         // Match the raised floor line of the door
  ...
  return (
    <div className="absolute inset-0 bg-[#1a1a1a] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute w-[20%] h-[78%] bottom-[6%] left-[40%] bg-black z-[70] rounded-sm shadow-inner" />

      {/* We position the Door on the floor aligned perfectly with the CharacterClown */}
      <Door
        onClick={handleDoorClick}
        label=""
        className={`w-[20%] h-[78%] bottom-[6%] left-[40%] ${doorZIndex}`}
        color="#6b4423"
