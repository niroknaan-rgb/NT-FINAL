  ...
  return (
    <div className="absolute inset-0 z-[100000] flex flex-col items-center justify-center bg-black text-white p-8 text-center" dir="rtl">
      ...
      <button 
        ...
        className="px-8 py-4 bg-white text-black font-bold rounded-full hover:bg-gray-200 transition-colors text-xl font-sans shadow-[0_0_20px_rgba(255,255,255,0.3)]"
      >
        המשך למשחק
      </button>
    </div>
...
const OrientationLock = ({ disabled, isPortrait }: { disabled?: boolean; isPortrait: boolean }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] bg-black text-white flex flex-col items-center justify-center p-8 text-center pointer-events-auto">
    ...
    return (
      <div className="fixed inset-0 bg-white z-[250] text-[#111111] flex flex-col items-center justify-center font-sans overflow-hidden" dir="rtl">
        ...
        <motion.div 
          ...
          className="w-full h-full bg-white flex flex-col items-center justify-center text-center relative py-8 px-6 overflow-y-auto overflow-x-hidden"
        >
          <div className="w-16 h-16 bg-red-50 text-red-650 rounded-full flex items-center justify-center mx-auto mb-4 border-2 border-red-500">
            <Check size={32} className="text-red-650" />
          </div>
          <h2 className="text-2xl md:text-3xl font-black mb-2 text-zinc-900">הפרטים נשמרו בהצלחה!</h2>
          <p className="text-sm md:text-base mb-5 leading-relaxed text-zinc-500">נרשמתם בהצלחה לרשימת המוזמנים של ההופעה הסודית של ניר!</p>
          
          <div className="border-4 border-double border-gray-300 p-6 rounded-2xl bg-amber-50/55 my-4 relative overflow-hidden text-right w-full max-w-md shadow-sm">
            ...
            <div className="text-[10px] font-mono text-zinc-400 mb-1 select-none text-left tracking-wide">TICKET #0{ticketNum}</div>
            <div className="text-lg font-extrabold text-zinc-900 border-b border-dashed border-gray-300 pb-2 mb-4 tracking-wide">הופעה סודית — ניר</div>
            
            <div className="space-y-2 text-sm md:text-base text-zinc-800">
              <div><span className="text-zinc-400 font-medium">שם מלא:</span> <strong>{firstName} {lastName}</strong></div>
              <div><span className="text-zinc-400 font-medium font-sans">טלפון:</span> <strong className="font-mono">{phone}</strong></div>
              <div className="truncate"><span className="text-zinc-400 font-medium font-sans">אימייל:</span> <strong className="font-mono">{email}</strong></div>
            </div>
            
            <div className="mt-5 pt-3 border-t border-dashed border-gray-300 text-center text-xs md:text-sm text-red-650 font-black bg-white/70 py-2 rounded-xl">
